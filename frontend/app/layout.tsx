...
export const metadata: Metadata = { title: "IntelliApply", description: "AI-powered career intelligence.", other: { "codex-preview": "development" }, icons: { icon: "/favicon.jpg", shortcut: "/favicon.svg" } };
