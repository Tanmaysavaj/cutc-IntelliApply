...
export default function Home() {
  ...
  return <main className={shell ? "app-shell" : "landing-shell"}>
    ...
    <section className={shell ? "app-main" : "landing-main"}>
      <Topbar page={page} setPage={setPage} theme={theme} toggleTheme={toggleTheme} isDemo={isDemo} onExitDemo={handleExitDemo} />
...
function Topbar({ page, setPage, theme, toggleTheme, isDemo, onExitDemo }: { page: Page; setPage: (p: Page) => void; theme: "light" | "dark"; toggleTheme: () => void; isDemo: boolean; onExitDemo: () => void }) {
